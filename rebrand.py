    ...
    for root, dirs, files in os.walk(directory):
        for file in files:
            if file.endswith((".py", ".json", ".md")):
                ...
                new_content = re.sub(
                    r"~/\.gemini(?![a-zA-Z0-9_-])", "~/.gemini-manager", new_content
                )
                ...
                new_content = re.sub(
                    r"\bgemini\b(?![_-]manager)", replace_gemini, new_content
                )
