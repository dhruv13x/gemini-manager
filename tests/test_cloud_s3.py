...
from gemini_manager.cloud_s3 import S3Provider
from botocore.exceptions import (
    ClientError,
)  # Import ClientError for mocking boto3 exceptions
...
def mock_s3_client():
    ...
    with patch("gemini_manager.cloud_s3.boto3.client") as mock_boto_client:
